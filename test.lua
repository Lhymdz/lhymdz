        ...
        task.spawn(function()
            while task.wait(0.1) do
                if Toggle.Value then
                    local cframe1 = CFrame.new(5140.5458984375, 42.349449157714844, -478.1697998046875)
                    local cframe2 = CFrame.new(5236.978515625, 42.34944152832031, -286.6861877441406)
                    local cframe3 = CFrame.new(4998.3486328125, 42.349449157714844, -117.01705169677734)
