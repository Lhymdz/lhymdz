        ...
        task.spawn(function()
            while task.wait(0.1) do
                if Toggle.Value then
                    local cframe1 = CFrame.new(5479.65771484375, 40.82205581665039, 382.72882080078125)
                    local cframe2 = CFrame.new(5504.1552734375, 41.85162353515625, -123.67731475830078)
                    local cframe3 = CFrame.new(5715.03076171875, 41.85169219970703, -129.33763122558594)
                    --local cframe4 = CFrame.new(5498.70556640625, 42.349430084228516, -546.9286499023438)
                    local speed = 1300
