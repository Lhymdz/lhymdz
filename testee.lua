        ...
        task.spawn(function()
            while task.wait(0.1) do
                if Toggle.Value then
                    ...
                    local cframe2 = CFrame.new(5507.95458984375, 45881622314453125, -135.23118591308594)
                    local cframe3 = CFrame.new(5475.6845703125, 44.85205078125, 389.8147277832031)
